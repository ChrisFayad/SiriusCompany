...
var data = {
  ...
  nl:
  {
    ...
    mis:`Missie`,
    val:`Waarde`,
    vis_txt:`Herstel de Uitstraling van Revalidatie.`,
    mis_txt:`Verdiepen door Technologie om de mensheid te voor zien van behoeften door mensen met een handicapte integreren.`,
    val_txt:`Om allemaal zo <span>GELIJK</span> waardij te zijn <span>EN</span> & Sprankje hoop op een Beter Leven te <span>Seven!</span>`,
    slog_txt:`Verspreid Gelijkenisvonk`,
  ...
  en:
  {
    ...
    val_txt:`To be all as <span>EQUAL</span> as <span>ONE</span> & Give a Spark of <span>HOPE</span> for a Better <span>LIFE!</span>`,
