...
var data = {
  ...
  nl:
  {
    ...
    Echo:`Echo+`,
    Argo:`Argo+`,
    Future:`Toekomst Plannen`,
    Echotxt:`Het is een Handschoen met een set sensoren om Gebarentaal te analyseren en te vertallen naar gesproken en geschreven in Arabische Taal.`,
    Argotxt:`Het is een Handschoen voor blinden/doven met een reeks aanraaksensoren aan de voorkant en een klein vibrerende motor van buitenaf om te zorgen voor communicatie met de nabije en verre mensen om hen heen en omgekeerd.`,
    Future_1:`Kunst Ledematen`,
    Future_2:`Niet-Chirurgische Spinale Decompressie Behandeling`,
    goal:`Ons <span>Doel</span> is om elke <span>Gehandicapte Persoon</span> in staat te stellen zich <span>Sociaal Geintegreerd</span> te voelen & de <span>Wereld</span> volledig te <span>Ervaren</span> zonder <span>Barrieres.</span>`,
